// Rendered at a fixed 240x420 so the Figma and Xcode layers can place the
// phone (and its wireframe twin) at identical coordinates for the wipe.
export const PHONE_W = 240;
...
export default function PhoneMockup() {
  return (
    <div
      className="shrink-0 rounded-[2.4rem] border-[6px] border-neutral-900 bg-white shadow-2xl"
    ...
    >
      <div className="flex h-full flex-col overflow-hidden rounded-[2rem] px-4 pb-3 pt-2 text-neutral-900">
        ...
        <div className="relative mt-1.5 min-h-0 flex-1 overflow-hidden rounded-xl bg-gradient-to-br from-neutral-800 to-neutral-950 p-2">
